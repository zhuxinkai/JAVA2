 ...
 *
 * @author : zhuxinkai
 * @date : 2019-12-07 22:03
 **/

@RestController
public class ManyUploadController {
 ...
 */
    ...
    public void upload(HttpServletResponse resp) {
        try {
            resp.sendRedirect("manyupload.html");
        } catch (IOException e) {
            e.printStackTrace();
        }
 ...
 */
    public String upload(@RequestParam("manyupload") MultipartFile [] uploadfiles, HttpServletRequest req) {
